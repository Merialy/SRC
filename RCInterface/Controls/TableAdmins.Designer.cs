...
namespace RCInterface
{
    partial class TableAdmins
    {
        ...
        private void InitializeComponent()
        {
            ...
            tSButton_Add.ToolTipText = "Додати адміністратора";
            ...
            tSButton_Remove.ToolTipText = "Видалити адміністратора";
            ...
            // 
            administratorBindingSource.DataSource = typeof(Administrator);
            // 
